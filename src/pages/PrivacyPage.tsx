      ...
      <div className="relative z-10 w-full max-w-[480px] px-6 py-20">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-[15px] leading-[1.7] text-[color:var(--color-mist)]">
            <p>
              Velness is built on the principle that your reflections are yours.
              We do not sell, share, or monetize your personal data.
            </p>
            <p>
              Your journal entries are encrypted and stored privately. They are
            ...
            <p>
              ...
              service — such as your email address for account access.
            </p>
            <p>
              As Velness is currently in private alpha, this policy may evolve
              as the product grows. Any significant changes will be communicated
              directly to active users.
            </p>
          </div>
